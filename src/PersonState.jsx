...
export function PersonState() {
	const initPerson = { firstName: "John", lastName: "Doe", age: 100 };
...
//   };
  ...
  const handleIncreaseAge = () => {
    ...
    setPerson(newPerson);
		...
		// this will show the same console msg as the previous console log because state has not been rerendered yet
